...
public class UserController {
    ...
    public ResponseEntity<List<UserDto.UserResponse>> getAllUsers() {
        List<UserDto.UserResponse> responses = userService.findAllUsers().stream().map(user -> modelMapper.map(user, UserDto.UserResponse.class)).collect(Collectors.toList());
